<template>
  <div class="profile">
    <div class="profile__head" ref="profileHead">
      <img
        :src="require(`@/assets/img/${this.accountInfo.img}`)"
        class="profile__icon"
        alt="profile__icon"
      />
    ...
    <div class="profile__body">
      <div class="profile__body-block">
        ...
        <span class="profile__body-value"> {{ this.hashRate }} H/s</span>
      </div>
      <div class="profile__body-block">
      ...
      <div class="profile__body-block">
        ...
        >
        <span class="profile__body-value"> {{ this.todayProfit }} BTC</span>
      </div>
      <div class="profile__body-block">
        <span class="profile__body-name">Всего выплачено</span>
        <span class="profile__body-value"> {{ this.myPayment }} BTC</span>
      </div>
    </div>
  </div>
</template>
