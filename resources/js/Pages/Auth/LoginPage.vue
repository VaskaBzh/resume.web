<template>
    <form @submit.prevent="submit" class="form form-auth">
        <main-title tag="h3">{{ this.$t("auth.login.title") }}</main-title>
        <div
        ...
        <blue-button class="auth" type="submit">
            <a class="all-link">{{
        ...
        <p class="text text-light">
            ...
            <Link :href="route('registration')" class="form_link">
