<template>
    <div ref="page" class="wallets">
        ...
        >
            <div class="wallets__no-information__content">
                <img
                    src="../../../assets/img/img_wallets-no-info.png"
                    alt=""
                ...
                <main-button
                    class="button-blue button-full wallets_button-no-information"
                    :class="{
    ...
    >
        ...
        >
            ...
            <main-button
                type="submit"
                class="button-full button-xl"
                :wait="wallets.waitChangeWallet"
            >
                <template #text>
...
export default {
    ...
    methods: {
        changeWallet(code = null) {
            if (!this.wallets.waitChangeWallet) {
                this.setCode(code);
...
.wallets_warning {
    margin: 80px 0 adaptive-value(12px, 24px);
    width: 100%;
}
