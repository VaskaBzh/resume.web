        ...
        <div class="statistics__main">
            ...
            >
                <tr class="statistics__titles">
                    <th v-for="(title, i) in table.titles" :key="i">
                        {{ title }}
                    </th>
                </tr>
                <tr
                ...
                >
                    ...
                    <td class="statistics__text statistics__change">
                        {{ row.change }}
                    </td>
                    <td class="statistics__text statistics__bits">
                        {{ row.bits }}
                    </td>
            ...
            <div v-else class="statistics__list_con">
                <ul class="statistics__list">
                    ...
                    >
                        ...
                        >
                            <div class="statistics__item_title">
                                {{ title }}
                            </div>
                            ...
                            <p
                                v-else-if="j == 3"
                                class="statistics__text statistics__change"
                            >
                                {{ row.change }}
                            </p>
                            <p
                                v-else-if="j == 4"
                                class="statistics__text statistics__bits"
                            >
                                {{ row.bits }}
                            </p>
