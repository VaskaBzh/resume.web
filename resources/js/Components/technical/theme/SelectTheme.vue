<template>
    <div class="checkbox" :class="{ active: isDark }" @click="changeActive()">
        ...
        >
            <path
                d="M22.6663 16.0002C22.6663 19.6821 19.6816 22.6668 15.9997 22.6668C12.3178 22.6668 9.33301 19.6821 9.33301 16.0002C9.33301 12.3183 12.3178 9.3335 15.9997 9.3335C19.6816 9.3335 22.6663 12.3183 22.6663 16.0002Z"
                stroke="#98A2B3"
                stroke-width="2"
            />
            <path
                d="M15.994 4H16.006M15.9948 28H16.0068M24.4784 7.51465H24.4904M7.51212 24.4854H7.52409M7.51212 7.5153H7.52409M24.4776 24.486H24.4896M27.988 16.0008H28M4 16.0008H4.01197"
                stroke="#98A2B3"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
