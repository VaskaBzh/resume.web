export const HostingMessage = {
    ...
    ru: {
        ...
        offer: {
            ...
            cards: {
                title: ['до 4%', 'персональная комиссия для ваших клиентов', 'до 75%', 'ваши вознаграждения по партнерской программе'],
                text: ['Комиссия нашего пула настраивается кастомно. Мы предоставляем вам выбор: дать скидку вашим клиента и предоставить выгодное предложение или увеличить вашу прибыль по партнёрской программе. Подробнее уточняйте у менеджера. ', 'Вы получаете большое вознаграждение по партнёрской программе, которое позволит зарабатывать больше от каждого вашего клиента. Процент вознаграждения зависит от подключенного хешрейта.']
            }
        },
        pluse: {
