            ...
            <form class="watchers__form">
                <div class="watchers__column">
                    <div class="watchers-add">
                        ...
                        <main-description>Наблюдатель получает возможность смотреть контент без возможности редактировать</main-description>
                    </div>
                    <main-input
                    ...
                    <div class="watchers__block">
                        <div class="watchers_label">Доступные страницы для наблюдения</div>
                ...
                <main-button @click="$emit('createWatcher', form)" class="button-blue button-full watchers_button">
    ...
    methods: {
        ...
        setAllowedRoutes(boolean, routes) {
            if (boolean)
                ...
                this.form.allowedRoutes = this.form.allowedRoutes.filter(route => routes.filter(r => r === route).length === 0);
        }
    },
    data() {
        return {
