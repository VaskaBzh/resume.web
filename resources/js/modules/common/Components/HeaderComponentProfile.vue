<template>
    <nav class="header-content">
        ...
        <div @click="$emit('changeBurger', !isOpenBurger)" class="burger-svg-mobile">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                <path d="M4.70312 5L20.7031 5M4.70312 12L20.7031 12M4.70312 19L20.7031 19" stroke="#2E90FA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
