<template>
    <div>
        ...
        <article class="article-tabs">
            ...
            <div class="nav-link-container">
                ...
                <button class="header-nav-tabs" @click="actionList('sub')">
                    ...
                    <div
                        :class="{
                            'open-arrow': isOpenSub,
                            'close-arrow': closeSubList,
                        }"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <button class="header-nav-tabs" @click="actionList('settings')">
                    ...
                    <div
                        :class="{
                            'open-arrow': isOpenSettings,
                            'close-arrow': closeSettingsList,
                        }"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="logout">
            ...
            >
                <path
                    d="M15.1 16.4603C14.79 20.0603 12.94 21.5303 8.89 21.5303H8.76C4.29 21.5303 2.5 19.7403 2.5 15.2703V8.75027C2.5 4.28027 4.29 2.49027 8.76 2.49027H8.89C12.91 2.49027 14.76 3.94027 15.09 7.48027M9 12.0203L20.38 12.0203M18.15 15.3703L21.5 12.0203L18.15 8.67027"
                    stroke="#98A2B3"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
