<template>
  <div class="accrual-card">
    ...
    <div class="accrual-today">
      <div class="flex-jc">
        <p class="title">Начислено</p>
        <button>
      ...
      <div class="today-data flex-jc">
          <span class="today-data-num">{{ this.unPayment }} BTC</span>
          <span class="today-data-num"> 0.005 BTC</span>
      </div>
      <div class="progress-bar">
        <div id="currentAccrual" class="current-accrual"></div>
      </div>
    </div>
  </div>
</template>
