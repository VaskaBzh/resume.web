...
export const ValidationFunctionsEnum = {
    ...
    min: (inputValue, minValue = 3) => inputValue.length < minValue && inputValue.length !== 0,

    isValid: (inputValue, ruleKey) => !ValidationRulesEnum[ruleKey].test(inputValue) && inputValue.length !== 0,
}
