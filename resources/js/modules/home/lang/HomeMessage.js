    ...
    en: {
        ...
        who_we_are: {
            ...
            card_community: {
                ...
                button: ['Learn more'],
                tooltip: 'With high capacity, you can get a personal reduced commission'
            }
        },
        profitability_calculator: {
            ...
            form_calculator: {
                ...
                tooltip: ['Average hashrate of all devices', 'The commission depends on the overall average hashrate: the higher the hashrate, the lower the commission'],
                item: ['Current difficulty', 'BTC rate'],
                segment: ['1 day', '1 month', '3 months'],
                text: 'For a more accurate profitability forecast, use Calculator Pro'
            }
        },
        why_allbtc: {
        ...
        payments: {
            button: 'payouts',
            title: ['reward method', 'autopayouts', 'average daily payout'],
        ...
        history: {
            ...
            text: [
                'We create sites for the placement of data centers, hosting and mining hotels. We cooperate with contractors in the Russian Federation and the CIS. We create turnkey mining zones: from renting to putting the farm into operation.',
                'Halving happened, mining difficulty increased. A development team has appeared. Our goal is to create up-to-date solutions to optimize the operation of industrial miners and data centers.',
                'Bitcoin has risen in price significantly. We have expanded our staff several times and created a monitoring system for data centers. In the same year, the first contracts for custom integration were concluded.',
                'We have officially registered a pool for mining cryptocurrencies. The first data centers connected to the system. Their profits increased by 50% for every kilowatt of energy spent.',
                'They stopped working only as a closed pool for data centers and entered the international market. We have ambitious plans by the end of 2023.'
            ]
        },
    ...
    ru: {
        ...
        who_we_are: {
            ...
            card_community: {
                ...
                tooltip: 'При больших мощностях вы можете получить персональную сниженную комиссию'
            }
        },
        profitability_calculator: {
            button: ['калькулятор доходности', 'калькулятор pro'],
            title: ['рассчитайте ', 'свой доход', 'с помощью', 'калькулятора', 'доходности'],
            ...
            form_calculator: {
                ...
                tooltip: ['Средний хешрейт всех устройств', 'Комиссия зависит от общего среднего хешрейта: чем больше хешрейт, тем меньше комиссия'],
        ...
        payments: {
            button: 'выплаты',
            title: ['метод вознаграждения', 'автовыплаты', 'средняя дневная выплата'],
        ...
        footer: {
            ...
            list: ['Главная', 'Дата-центрам', 'Майнерам', 'FAQ', 'Новости', 'Контакты'],
