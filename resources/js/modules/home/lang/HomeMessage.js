    ...
    en: {
        ...
        who_we_are: {
            ...
            card_community: {
                ...
                num: ["No.1", "24/7", "1", "4%"], 
                text: ["customer service", "fast technical support", "screen for all statistics", "max commission",],
                button: ["Learn more"], 
                tooltip: "With high capacity, you can get personal commission redused", 
            },
    },
        profitability_calculator: {
            button: ["profitability calculator", "calculator pro"], 
            title: ["calculate", "your income", "with the help of", "profitability", "calculator",],
