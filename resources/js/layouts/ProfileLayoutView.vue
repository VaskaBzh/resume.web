        ...
        <div class="layout__content">
            ...
            <div class="page-container">
                <div :class="{ 'note-animation': messageNote }">
                    <div class="notification-card" v-if="messageNote" :class="[isGreen? 'green-card' : 'red-card']">
