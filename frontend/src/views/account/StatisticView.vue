<template>
  <div class="statistic">
    <div class="statistic__wrapper">
      <main-title tag="h2" class="statistic__title">Статистика</main-title>
      ...
      <div class="statistic__wrap">
        <div class="statistic__wrap_head">
          ...
          <div class="statistic__legend">
            <div class="statistic__legend_elem statistic__legend_elem-active">
              Активные: {{ this.active }}
            </div>
            <div class="statistic__legend_elem statistic__legend_elem-unstable">
              Нестабильные: {{ this.unstable }}
            </div>
            <div class="statistic__legend_elem statistic__legend_elem-unactive">
              Неактивные: {{ this.unactive }}
            </div>
            <div class="statistic__legend_elem statistic__legend_elem-all">
              Все: {{ this.all }}
            </div>
          </div>
        </div>
        ...
        <router-link class="statistic__link main__link" to="/workers"
          >Расширенная страница воркеров</router-link
        >
      </div>
      <div class="statistic__wrap">
        <div class="statistic__wrap_head">
        ...
        <router-link class="statistic__link main__link" to="/payment"
          >Расширенная страница выплат</router-link
        >
      </div>
    </div>
  </div>
      ...
      graphs: [
        {
          id: 1,
          title: ["Хешрейт", "Время"],
          values: [48, 70, 55, 105, 103, 145, 90, 140, 105, 150, 160, 190, 90],
        },
      ],
      active: 1,
      unstable: 1,
