    ...
    <div class="home__container">
      <div class="home__main">
        <div class="home__content">
          <main-title tag="h1" class="home__title" v-scroll="'left delay--lg'">
...
.home {
  ...
  &__background {
    ...
    // .home__background_5
    &_5 {
      animation: keyshow5 1.2s ease forwards, imag5 12s 1.2s infinite linear;
    }
    @keyframes imag5 {
      0% {
        top: 25.3em;
